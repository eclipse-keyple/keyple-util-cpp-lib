...
public:
    ...
    build(const uint8_t cla, const uint8_t ins, const uint8_t p1, const uint8_t p2);
     ...
     *
     * <p>The ISO7816 case for data in a command-response pair is determined from
     ...
     * letting the lower layer (see API plugin) take care of recovering the exact
