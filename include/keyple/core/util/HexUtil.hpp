...
public:
     ...
     *
     * <p>Caution: the result may be erroneous if the string does not contain
     ...
     *
     * <p>Note: if the hexadecimal string contains more than two characters,
     * then only the last two characters will be taken into account. In this
     ...
     *
     * <p>Note: if the hexadecimal string contains more than four characters,
     * then only the last four characters will be taken into account. In this
     * case, please note that the conversion processing will be less performant.
     *
     * <p>Caution: the result may be erroneous if the string does not contain
     * only hexadecimal characters.
