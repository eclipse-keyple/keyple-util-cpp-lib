...
public:
     ...
     *
     * <p>Caution: the result may be erroneous if the string does not contain only
     * hexadecimal characters.
     *
     * @param hex The hexadecimal string to convert.
     * @return An empty byte array if the input string is empty.
     * @throw StringIndexOutOfBoundsException If the input string is made of an
     ...
     *
     * <p>Note: if the hexadecimal string contains more than two characters, then
     * only the last two characters will be taken into account. In this case,
     * please note that the conversion processing will be less performant.
     *
     * <p>Caution: the result may be erroneous if the string does not contain only
     * hexadecimal characters.
     *
     ...
     *
     * <p>Note: if the hexadecimal string contains more than four characters, then
     * only the last four characters will be taken into account. In this case,
     * please note that the conversion processing will be less performant.
     *
     * <p>Caution: the result may be erroneous if the string does not contain only
     * hexadecimal characters.
     ...
     *
     * <p>Note: if the hexadecimal string contains more than eight characters,
     * then only the last eight characters will be taken into account. In this
     * case, please note that the conversion processing will be less performant.
     *
     * <p>Caution: the result may be erroneous if the string does not contain only
     * hexadecimal characters.
     *
     ...
     *
     * <p>Note: if the hexadecimal string contains more than sixteen characters,
     * then only the last sixteen characters will be taken into account. In this
     * case, please note that the conversion processing will be less performant.
     *
     * <p>Caution: the result may be erroneous if the string does not contain only
     * hexadecimal characters.
     ...
     *
     * <p>Note: the returned string has an even length and is left truncated if
     * necessary to keep only the significant characters.
     *
