...
const char* TLV1 = "6F238409315449432E49434131A516BF0C13C708000000001122334453070A3C2005141001";
const char* TLV2 = "6F23A516BF0C1353070A3C2005141001C70800000000112233448409315449432E49434131";
...
TEST(BerTlvUtilTest, parse_whenStructureIsValidAndPrimitiveOnlyIsFalse_shouldProvideAllTags) {
    ...
    ASSERT_TRUE(vectorContainsExactly(
        tlvs[0xA5], HexUtil::toByteArray("BF0C13C708000000001122334453070A3C2005141001")));
    ASSERT_TRUE(vectorContainsExactly(
        tlvs[0xBF0C], HexUtil::toByteArray("C708000000001122334453070A3C2005141001")));
...
TEST(BerTlvUtilTest, parse_whenStructureIsValidAndPrimitiveOnlyIsFalse_shouldProvideAllTags2) {
    ...
    ASSERT_TRUE(vectorContainsExactly(
        tlvs[0xE0],
        HexUtil::toByteArray("C106200107021D01C106202009021D04C106206919091D01C10"
